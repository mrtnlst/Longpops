    ...
    override func setupConstraints() {
        ...
        if #available(iOS 11, *) {
            ...
            NSLayoutConstraint.activate([
                ...
                self.permissionButtonContainerView.topAnchor.constraintEqualToSystemSpacingBelow(self.textFieldContainerView.bottomAnchor, multiplier: LayoutHandler.getMultiplierForDevice()),
                ])
        }
